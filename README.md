...
### Prerequisites for client:
 - Android:
   ...
   - Android 11+:
     - MacroDroid (https://play.google.com/store/apps/details?id=com.arlosoft.macrodroid&hl=en_US&gl=US#:~:text=MacroDroid%20is%20the%20easiest%20way%20to%20automate%20tasks,how%20MacroDroid%20can%20help%20you%20to%20get%20automated:) - optional
	   - Go to Templates and search for `RetroArcher ADB enabled`, please star the macro.
...
2. If using GeForce Experience:
  ...
  5. Click "Edit" and rename to "RetroArcher"
  6. Change the BoxArt if you wish (https://github.com/ReenigneArcher/RetroArcher.database/blob/main/Posters/3-4/RetroArcher/RetroArcher.png).
  7. Open Moonlight on a client app
  8. Long press okay on your server name and select `View Details`, make a note of the `Name` and `UUID`, select `OK`
  9. Select the server and enter the pairing code on your server
  10. Long press ok on the app you created in Step 3-6 and select `View Details`, make a note of the `Name` and `ID`, select `OK`
