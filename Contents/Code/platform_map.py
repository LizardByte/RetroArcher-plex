...
platform_map = {
    ...
    'Commodore 64': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['d64', 'd71', 'd80', 'd81', 'd82', 'g64', 'g41', 'x64', 't64', 'tap', 'prg', 'p00', 'crt',
                          'bin', 'zip', 'gz', 'd6z', 'd7z', 'd8z', 'g6z', 'g4z', 'x6z', 'cmd', 'vfl', 'vsf', 'nib',
                          'nbz', 'lnx'],
        'romType': 0,
        'multiDisk': True,
        'emulators': {
            ...
            'retroarch':
                {'cores': {
                    ...
                    'vice_x64_libretro.dll': {
                        'coreExtensions': ['d64', 'd71', 'd80', 'd81', 'd82', 'g64', 'g41', 'x64', 't64', 'tap', 'prg',
                                           'p00', 'crt', 'bin', 'zip', 'gz', 'd6z', 'd7z', 'd8z', 'g6z', 'g4z', 'x6z',
                                           'cmd', 'm3u', 'vfl', 'vsf', 'nib', 'nbz'],
    ...
    'Commodore Amiga': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['adf', 'adz', 'dms', 'fdi', 'ipf', 'hdf', 'hdz', 'lha', 'slave', 'info', 'cue', 'ccd', 'nrg',
                          'mds', 'iso', 'chd', 'uae', 'zip', '7z'],
        'romType': 0,
        'multiDisk': True,
        'emulators': {
            0: 'retroarch',  # agent enums to emulator name
            ...
            'retroarch':
                {'cores': {
                    ...
                    'puae_libretro.dll': {
                        'coreExtensions': ['adf', 'adz', 'dms', 'fdi', 'ipf', 'hdf', 'hdz', 'lha', 'slave', 'info',
                                           'cue', 'ccd', 'nrg', 'mds', 'iso', 'chd', 'uae', 'm3u', 'zip', '7z'],
    ...
    'Magnavox Odyssey': {
        'systemNames': ['Magnavox Odyssey', 'Magnavox Odyssey 1', 'Odyssey 1', 'Odyssey', 'Odysee', 'Odisea',
                        'Odissea'],
        'systemIds': {
            'igdb': 88,
            'thegamesdb': 4961
    ...
    'Magnavox Odyssey 2': {
        'systemNames': ['Magnavox Odyssey 2', 'Philips Videopac+', 'Philips Videopac G7000', 'Magnavox Odyssey\u00b2',
        ...
        'emulators': {
            ...
            'retroarch':
                {'cores': {
                    ...
                    5: 'dosbox_svn_libretro.dll',  # DOSBox-SVN
                    'dosbox_libretro.dll': {
                    ...
                    'dosbox_pure_libretro.dll': {
                        'coreExtensions': ['zip', 'dosz', 'exe', 'com', 'bat', 'iso', 'cue', 'ins', 'img', 'ima', 'vhd',
                                           'm3u', 'm3u8'],
    ...
    'Microsoft Windows 3.X': {
        'systemNames': ['Microsoft Windows 3.X', 'Windows 3.X', 'PC (Microsoft Windows 3.X)', 'Microsoft Windows 3.1',
                        'Windows 3.1', 'PC (Microsoft Windows 3.1)'],
        'systemIds': {
            'igdb': 6,
            'thegamesdb': 1
        },
    ...
    'NEC PC-9801': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['d98', 'zip', '98d', 'fdi', 'fdd', '2hd', 'tfd', 'd88', '88d', 'hdm', 'xdf', 'dup', 'cmd',
                          'hdi', 'thd', 'nhd', 'hdd'],
        'romType': 0,
        'multiDisk': False,
        'emulators': {
            ...
            'retroarch':
                {'cores': {
                    ...
                    'nekop2_libretro.dll': {
                        'coreExtensions': ['d98', 'zip', '98d', 'fdi', 'fdd', '2hd', 'tfd', 'd88', '88d', 'hdm', 'xdf',
                                           'dup', 'cmd', 'hdi', 'thd', 'nhd', 'hdd'],
                        'friendlyName': 'NEC - PC-98 (Neko Project II)'
                    },
                    'np2kai_libretro.dll': {
                        'coreExtensions': ['d98', 'zip', '98d', 'fdi', 'fdd', '2hd', 'tfd', 'd88', '88d', 'hdm', 'xdf',
                                           'dup', 'cmd', 'hdi', 'thd', 'nhd', 'hdd', 'hdn'],
    ...
    'Nintendo 64DD': {
        'systemNames': ['Nintendo 64DD', 'N64DD', '64DD'],
        'systemIds': {
            'igdb': 416,
            'thegamesdb': 3
        },
    ...
    'Nintendo Famicom Disk System': {
        'systemNames': ['Nintendo Famicom Disk System', 'Family Computer Disk System', 'fds', 'Famicom Disk System',
                        'NFDS', 'Nintendo Family Computer Disk System'],
        'systemIds': {
            'igdb': 51,
            'thegamesdb': 4936
        },
    ...
    'Nintendo Game and Watch': {
        'systemNames': ['Nintendo Game and Watch', 'Nintendo Game & Watch', 'Game & Watch', 'Game and Watch',
                        'Tricotronic'],
        'systemIds': {
            'igdb': 307,
            'thegamesdb': 4950
            ...
            'retroarch':
                {'cores': {
                    ...
                    'dolphin_libretro.dll': {
                        'coreExtensions': ['gcm', 'iso', 'wbfs', 'ciso', 'gcz', 'elf', 'dol', 'dff', 'tgc', 'wad',
                                           'rvz', 'm3u'],
    ...
    'Nintendo Super Famicom': {
        'systemNames': ['Nintendo Super Famicom', 'SFAM', 'Super Famicom', 'SFC', 'Super Family Computer', 'NSFAM',
                        'NSFC', 'Nintendo Super Family Computer'],
        'systemIds': {
            'igdb': 58,
            'thegamesdb': 6
        },
    ...
    'ScummVM': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['0', '1', '2', '3', '5', '6', '8', '16', '25', '99', '101', '102', '418', '455', '512',
                          'scummvm', 'scumm', 'gam', 'z5', 'dat', 'blb', 'z6', 'RAW', 'ROM', 'taf', 'zblorb', 'dcp',
                          '(a)', 'cup', 'HE0', '(A)', 'D$$', 'STK', 'z8', 'hex', 'VMD', 'TGA', 'ITK', 'SCN', 'INF',
                          'pic', 'Z5', 'z3', 'blorb', 'ulx', 'DAT', 'cas', 'PIC', 'acd', '006', 'SYS', 'alr', 't3',
                          'gblorb', 'tab', 'AP', 'CRC', 'EXE', 'z4', 'W32', 'MAC', 'mac', 'WIN', '001', '003', '000',
                          'bin', 'exe', 'asl', 'AVD', 'INI', 'SND', 'cat', 'ANG', 'CUP', 'SYS16', 'img', 'LB', 'TLK',
                          'MIX', 'VQA', 'RLB', 'FNT', 'win', 'HE1', 'DMU', 'FON', 'SCR', 'TEX', 'HEP', 'DIR', 'DRV',
                          'MAP', 'a3c', 'GRV', 'CUR', 'OPT', 'gfx', 'ASK', 'LNG', 'ini', 'RSC', 'SPP', 'CC', 'BND',
                          'LA0', 'TRS', 'add', 'HRS', 'DFW', 'DR1', 'ALD', '004', '002', '005', 'R02', 'R00', 'C00',
                          'D00', 'GAM', 'IDX', 'ogg', 'TXT', 'GRA', 'BMV', 'H$$', 'MSG', 'VGA', 'PKD', 'OUT', '99 (PG)',
                          'SAV', 'PAK', 'BIN', 'CPS', 'SHP', 'DXR', 'dxr', 'gmp', 'SNG', 'C35', 'C06', 'WAV', 'SMK',
                          'wav', 'CAB', 'game', 'Z6', '(b)', 'slg', 'he2', 'he1', 'HE2', 'SYN', 'PAT', 'NUT', 'nl',
                          'PRC', 'V56', 'SEQ', 'P56', 'AUD', 'FKR', 'EX1', 'rom', 'LIC', '$00', 'ALL', 'LTK', 'txt',
                          'acx', 'VXD', 'ACX', 'mpc', 'msd', 'ADF', 'nib', 'HELLO', 'dsk', 'xfd', 'woz', 'd$$', 'SET',
                          'SOL', 'Pat', 'CFG', 'BSF', 'RES', 'IMD', 'LFL', 'SQU', 'rsc', 'BBM', '2 US', 'OVL', 'OVR',
                          '007', 'PNT', 'pat', 'CHK', 'MDT', 'EMC', 'ADV', 'FDT', 'GMC', 'FMC', 'info', 'HPF', 'hpf',
                          'INE', 'RBT', 'CSC', 'HEB', 'MID', 'lfl', 'LEC', 'HNM', 'QA', '009', 'PRF', 'EGA', 'MHK',
                          'd64', 'prg', 'LZC', 'flac', 'IMS', 'REC', 'MOR', 'doc', 'HAG', 'AGA', 'BLB', 'TABLE', 'PAL',
                          'PRG', 'CLG', 'ORB', 'BRO', 'bro', 'PH1', 'DEF', 'IN', 'jpg', 'TOC', 'j2', 'Text', 'CEL',
                          'he0', 'AVI', '1C', '1c', 'BAK', 'L9', 'CGA', 'HRC', 'mhk', 'RED', 'SM0', 'SM1', 'SOU', 'RRM',
                          'LIB', " Seuss's  ABC", 'CNV', 'VOC', 'OGG', 'GME', 'GERMAN', 'SHR', 'FRENCH', 'DNR', 'DSK',
                          'dnr', 'CAT', 'V16', 'cab', 'CLU', 'b25c', 'RL', 'mp3', 'FRM', 'SOG', 'HEX', 'mma', 'st',
                          'MPC', 'IMG', 'ENC', 'SPR', 'AD', 'C', 'CON', 'PGM', 'Z', 'RL2', 'MMM', 'OBJ', 'ZFS', 'zfs',
                          'STR', 'z2', 'z1'],
        'romType': 0,
        'multiDisk': False,
        'emulators': {
            ...
            'retroarch':
                {'cores': {
                    ...
                    'scummvm_libretro.dll': {
                        'coreExtensions': ['0', '1', '2', '3', '5', '6', '8', '16', '25', '99', '101', '102', '418',
                                           '455', '512', 'scummvm', 'scumm', 'gam', 'z5', 'dat', 'blb', 'z6', 'RAW',
                                           'ROM', 'taf', 'zblorb', 'dcp', '(a)', 'cup', 'HE0', '(A)', 'D$$', 'STK',
                                           'z8', 'hex', 'VMD', 'TGA', 'ITK', 'SCN', 'INF', 'pic', 'Z5', 'z3', 'blorb',
                                           'ulx', 'DAT', 'cas', 'PIC', 'acd', '006', 'SYS', 'alr', 't3', 'gblorb',
                                           'tab', 'AP', 'CRC', 'EXE', 'z4', 'W32', 'MAC', 'mac', 'WIN', '001', '003',
                                           '000', 'bin', 'exe', 'asl', 'AVD', 'INI', 'SND', 'cat', 'ANG', 'CUP',
                                           'SYS16', 'img', 'LB', 'TLK', 'MIX', 'VQA', 'RLB', 'FNT', 'win', 'HE1', 'DMU',
                                           'FON', 'SCR', 'TEX', 'HEP', 'DIR', 'DRV', 'MAP', 'a3c', 'GRV', 'CUR', 'OPT',
                                           'gfx', 'ASK', 'LNG', 'ini', 'RSC', 'SPP', 'CC', 'BND', 'LA0', 'TRS', 'add',
                                           'HRS', 'DFW', 'DR1', 'ALD', '004', '002', '005', 'R02', 'R00', 'C00', 'D00',
                                           'GAM', 'IDX', 'ogg', 'TXT', 'GRA', 'BMV', 'H$$', 'MSG', 'VGA', 'PKD', 'OUT',
                                           '99 (PG)', 'SAV', 'PAK', 'BIN', 'CPS', 'SHP', 'DXR', 'dxr', 'gmp', 'SNG',
                                           'C35', 'C06', 'WAV', 'SMK', 'wav', 'CAB', 'game', 'Z6', '(b)', 'slg', 'he2',
                                           'he1', 'HE2', 'SYN', 'PAT', 'NUT', 'nl', 'PRC', 'V56', 'SEQ', 'P56', 'AUD',
                                           'FKR', 'EX1', 'rom', 'LIC', '$00', 'ALL', 'LTK', 'txt', 'acx', 'VXD', 'ACX',
                                           'mpc', 'msd', 'ADF', 'nib', 'HELLO', 'dsk', 'xfd', 'woz', 'd$$', 'SET',
                                           'SOL', 'Pat', 'CFG', 'BSF', 'RES', 'IMD', 'LFL', 'SQU', 'rsc', 'BBM', '2 US',
                                           'OVL', 'OVR', '007', 'PNT', 'pat', 'CHK', 'MDT', 'EMC', 'ADV', 'FDT', 'GMC',
                                           'FMC', 'info', 'HPF', 'hpf', 'INE', 'RBT', 'CSC', 'HEB', 'MID', 'lfl', 'LEC',
                                           'HNM', 'QA', '009', 'PRF', 'EGA', 'MHK', 'd64', 'prg', 'LZC', 'flac', 'IMS',
                                           'REC', 'MOR', 'doc', 'HAG', 'AGA', 'BLB', 'TABLE', 'PAL', 'PRG', 'CLG',
                                           'ORB', 'BRO', 'bro', 'PH1', 'DEF', 'IN', 'jpg', 'TOC', 'j2', 'Text', 'CEL',
                                           'he0', 'AVI', '1C', '1c', 'BAK', 'L9', 'CGA', 'HRC', 'mhk', 'RED', 'SM0',
                                           'SM1', 'SOU', 'RRM', 'LIB', " Seuss's  ABC", 'CNV', 'VOC', 'OGG', 'GME',
                                           'GERMAN', 'SHR', 'FRENCH', 'DNR', 'DSK', 'dnr', 'CAT', 'V16', 'cab', 'CLU',
                                           'b25c', 'RL', 'mp3', 'FRM', 'SOG', 'HEX', 'mma', 'st', 'MPC', 'IMG', 'ENC',
                                           'SPR', 'AD', 'C', 'CON', 'PGM', 'Z', 'RL2', 'MMM', 'OBJ', 'ZFS', 'zfs',
                                           'STR', 'z2', 'z1'],
            ...
            'retroarch':
                {'cores': {
                    ...
                    'genesis_plus_gx_libretro.dll': {
                        'coreExtensions': ['mdx', 'md', 'smd', 'gen', 'bin', 'cue', 'iso', 'sms', 'bms', 'gg', 'sg',
                                           '68k', 'chd'],
    ...
    'Sega Dreamcast': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['chd', 'cdi', 'iso', 'elf', 'cue', 'gdi', 'lst', 'zip', 'dat', '7z'],
        # removed bin... use cue files
        'romType': 0,
        'multiDisk': True,
        'emulators': {
            0: 'retroarch',  # agent enums to emulator name
            ...
            'retroarch':
                {'cores': {
                    ...
                    'flycast_libretro.dll': {
                        'coreExtensions': ['chd', 'cdi', 'iso', 'elf', 'bin', 'cue', 'gdi', 'lst', 'zip', 'dat', '7z',
                                           'm3u'],
    ...
    'Sega Game Gear': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['mdx', 'md', 'smd', 'gen', 'cue', 'iso', 'sms', 'bms', 'gg', 'sg', '68k', 'chd', 'rom',
                          'col', ],
        'romType': 0,
        'multiDisk': False,
        'emulators': {
    ...
    'Sega SG-1000': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['mdx', 'md', 'smd', 'gen', 'cue', 'iso', 'sms', 'bms', 'gg', 'sg', '68k', 'chd', 'rom', 'ri',
                          'mx1', 'mx2', 'col', 'dsk', 'cas', 'sc', 'zip'],
        'romType': 0,
        'multiDisk': True,
        'emulators': {
            0: 'retroarch',  # agent enums to emulator name
        ...
        'emulators': {
            ...
            'retroarch':
                {'cores': {
                    ...
                    'x1_libretro.dll': {
                        'coreExtensions': ['dx1', 'zip', '2d', '2hd', 'tfd', 'd88', '88d', 'hdm', 'xdf', 'dup', 'tap',
                                           'cmd'],
        ...
        'emulators': {
            ...
            'retroarch':
                {'cores': {
                    ...
                    'pk68k_libretro.dll': {
                        'coreExtensions': ['dim', 'zip', 'img', 'd88', '88d', 'hdm', 'dup', '2hd', 'xdf', 'hdf', 'cmd',
                                           'm3u'],
    ...
    'Sony PlayStation': {
        ...
        'libraryType': 'Games',
        'romExtensions': ['cbn', 'ccd', 'chd', 'cue', 'exe', 'img', 'mdf', 'pbp', 'toc'],
        # don't include bin during scanning
        'romType': 0,
