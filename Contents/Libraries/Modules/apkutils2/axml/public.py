...
SYSTEM_RESOURCES = {
    "attributes": {
        "forward": {k: v for k, v in list(resources['attr'].items())},
        "inverse": {v: k for k, v in list(resources['attr'].items())}
    },
    "styles": {
        "forward": {k: v for k, v in list(resources['style'].items())},
        "inverse": {v: k for k, v in list(resources['style'].items())}
    }
}
